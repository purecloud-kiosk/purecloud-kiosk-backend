...
class EventsDBService{
   ...
   * call the callback.
   **/
  validateEventIDAndCheckIn(eventID, checkInData, callback){
   ...
   **/
  updateEvent(eventData, callback){
   ...
   **/
  addAttendee(eventID, checkInData, callback){
   ...
   * This function allows
   **/
  checkIntoEvent(eventID, checkInData, callback){
    validateEventIDAndCheckIn(eventID, checkInData, function(error, event){
      if(error){
        callback(error);
      }
