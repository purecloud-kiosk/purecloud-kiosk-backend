...
class NotificationService{
   ...
   *  @param {string} options.recipientID (optional field)
   *  @param {string} options.store - whether to store the notification or not
   **/
   ...
   **/
  getNotification(id){
    console.log('retrieving notification');
