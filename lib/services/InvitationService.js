...
var InviteServiceError = require('lib/models/errors/InviteServiceError').InviteServiceError;
var InviteServiceError = require('lib/models/errors/InviteServiceError').errorTypes;
  ...
  sendInvite(options){
    return new Promise((resolve, reject) => {
      sendInvitation({
        ...
        reject(new InviteServiceError('Failed to send invite', errorTypes.UNABLE_TO_SEND_INVITE_ERROR));
      });
    });
  }
  /**
