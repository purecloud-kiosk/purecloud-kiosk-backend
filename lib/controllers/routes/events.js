...
router.get('/getEventCheckIns', function(req, res){
 ...
 router.post('/addPrivateAttendee', function(req, res){
   eventsService.addPrivateAttendee(req.body.eventID, req.user, req.body.attendee, function(error, result){
     if(error){
       res.status(400).send(error);
     }
     else{
 ...
 router.post('/addEventManager', function(req, res){
   eventsService.addEventManager(req.body.eventID, req.user, req.body.manager, function(error, result){
     if(error){
       res.status(400).send(error);
     }
     else{
