...
// class constructor
var PureCloudAPIDao = function(){

};

// function definitions
PureCloudAPIDao.prototype.genRequestOptions = function (url, method, token, data){
  var options = {
    'url': url,
    'method': method,
    'headers': {
 ...
 **/
PureCloudAPIDao.prototype.login = function(params, callback){
 ...
 **/
PureCloudAPIDao.prototype.getSession = function(access_token, callback){
    request(this.genRequestOptions("https://apps.mypurecloud.com/api/v2/session","GET", access_token), callback);
};
/**
 * Sends a get request to /api/v2/search
 *
 **/
PureCloudAPIDao.prototype.searchPeople = function(access_token, params, callback){
...
module.exports = PureCloudAPIDao;
